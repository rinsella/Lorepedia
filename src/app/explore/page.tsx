  ...
  return (
    <div>
      ...
      <section className="relative border-b bg-card/40">
        <div className="container py-14 max-w-4xl text-center">
          <Compass className="mx-auto h-10 w-10 text-primary" />
          <h1 className="font-serif text-4xl md:text-5xl font-semibold mt-4">Explore public worlds</h1>
          ...
          <form className="mt-7 max-w-xl mx-auto flex gap-2">
